...
document.addEventListener('DOMContentLoaded', () => {
    const accordionTitle = document.querySelector('.works-filter__accordion-title');
    const accordionWrap = document.querySelector('.works-filter__accordion');

    if (accordionTitle && accordionWrap) {
        accordionTitle.addEventListener('click', () => {
            accordionWrap.classList.toggle('is-open');
        });
    }
});
